...
//	char testChar2 = 0;
	...
	return returnValue_ptr;
		...
		//return char pointer to the first occurrence of the searchWord_ptr string found in the sentence_ptr string using memory address (index number)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Complete NULL checks
		...
		//check null for search longer than string
	

		//start process to search for searchWord with a for loop wiht if/for loops nested inside
		 //if the first letter of the key matches the current value.
			 //checks for the rest of the Key
						 //no match
